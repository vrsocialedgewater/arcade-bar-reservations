...
Route::prefix('admin')->middleware([AdminAuthMiddleware::class]) ->group(function () {
    ...
    Route::get('service_types', \App\Livewire\Admin\ServiceType\Index::class);
    Route::get('service_types/{service_type_id}', \App\Livewire\Admin\ServiceType\View::class);

    Route::get('services', \App\Livewire\Admin\Service\Index::class);
    Route::get('services/{service_id}', \App\Livewire\Admin\Service\View::class);

    Route::get('additional_services', \App\Livewire\Admin\AdditionalService\Index::class);
    Route::get('additional_services/{additional_service_id}', \App\Livewire\Admin\AdditionalService\View::class);
...
Route::get('/orders/{order_unique_id}/invoice', function ($order_unique_id) {
    ...
    $booking = Booking::whereHas('order', function ($q){$q->where('status', 'succeeded');})->where("order_id", $order_id)->with('additionalServices', 'location', 'service.serviceType', 'bookingSchedule', 'order')->firstOrFail();
    $additional_price = 0;
