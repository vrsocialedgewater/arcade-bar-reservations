...
{
    public $location_id, $service_type_id, $service_id, $quantity, $persons, $date, $booking_schedule_id, $location, $service_type_text, $service_text, $schedule, $price, $total_price, $additional_service_ids = [],
        $additional_services = [], $additional_price = 0, $email, $name, $number, $checkout = false, $has_payment = false, $slots = 0, $service_image,$fixed_price,$extended_price,$subtotal_price,$fee,$partial_payment;
    ...
    #[On('set_service')]
    public function setService($id, $text, $price, $slot, $image, $fixed_price, $extended_price)
    {
        $this->service_id = $id;
    ...
    public function setSubtotalPrice(){
        $this->subtotal_price = $this->fixed_price ? ($this->persons * $this->additional_price) + $this->price : $this->persons * ($this->price + $this->additional_price);
        $this->fee = $this->subtotal_price * 0.06;
        $this->total_price = $this->subtotal_price + $this->fee;
        $this->partial_payment = $this->fee;
    }
}
