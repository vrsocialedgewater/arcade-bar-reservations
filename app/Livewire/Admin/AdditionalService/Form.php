...
{
    use WithFileUploads;
    public $title,$description,$price,$service_ids,$cover_image,$old_cover_image,$image,$item,$services,$options, $selectedServices;
    ...
    public function editForm($item)
    {
        ...
        $this->service_ids = @$itemColl->service_id;
