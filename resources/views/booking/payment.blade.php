...
<div>
    ...
    <form id="payment-form" >
        ...
        <div class="mb-3">
            ...
            <label for="amount" class="form-label">Partial Amount: ${{ @$order->partial_payment }}</label>
...
{{--        </div>--}}
        ...
        <button type="submit" class="btn btn-success w-100" onclick="showLoadingOverlay()"> ${{ @$order->partial_payment }} Pay Now</button>
    </form>
