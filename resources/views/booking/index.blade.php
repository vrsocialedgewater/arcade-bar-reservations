                            ...
                            <form class="g-3" wire:submit="makePayment">
                                <div style="display: {{ $checkout ? "none" : "block" }}">
                                    ...
                                    @if($service_type_id && $location_id)
                                        <livewire:booking.service location_id="{{ $location_id }}" service_type_id="{{ $service_type_id }}"/>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    @if(@$persons && $price)
                                                        ...
                                                        @endif
                                                        @if(!empty($additional_services))
                                                            <h5 class="f-m-light mt-1 text-white">Additional Price ${{ $additional_price }} </h5>
                                                        @endif
                                                        <h5 class="f-m-light mt-1 text-white">Players {{ $persons }}
                                                            @if(!$fixed_price)
                                                                x ${{ $price + $additional_price }}
                                                            @endif
                                                        </h5>
                                    ...
                                    @if($persons > 0 && $date && $service_id)
                                        <div class="card border-0">
                                            <div class="card-body">
                                                <button type="button" wire:click="checkoutOn" class="btn btn-info btn-lg float-end">Proceed to checkout</button>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                            ...
                                            <div class="card checkout-summery">
                                                ...
                                                <div class="card-body bg-primary text-white">
                                                    ...
                                                    @if(@$persons && $price)
                                                        ...
                                                        <h5 class="f-m-light mt-1 text-white">6% Booking Fee ${{ $fee }}</h5>
                                                        <h5 class="f-m-light mt-1 text-white">Total ${{ $total_price }}</h5>
                                                        <h5 class="f-m-light mt-1 text-white">Partial Amount ${{ $fee }}</h5>
                                                        <h5 class="f-m-light mt-1 text-white">Due Amount ${{ $subtotal_price }}</h5>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
