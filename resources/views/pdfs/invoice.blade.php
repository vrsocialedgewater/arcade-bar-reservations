...
<div class="header">
    ...
    <h4>Your {{ \Carbon\Carbon::createFromFormat('H:i:s', @$booking->bookingSchedule->start_time)->diffInMinutes(@$booking->bookingSchedule->end_time) + 1 }}-Minutes {{ @$booking->service->title }} has been successfully booked! </h4>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <b>Partially Paid</b>: $ {{ @$booking->order->partial_payment }} <br/>
                    <b>Due Amount</b>: $ {{ @$booking->order->due_amount }} <br/>
                </td>
            </tr>
        </table>
    </div>
